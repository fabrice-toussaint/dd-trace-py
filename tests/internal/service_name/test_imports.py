...
def test_service_names_import_default():
    ...
    from ddtrace.internal.utils.schema.span_attribute_schema import cache_operation_v0
    from ddtrace.internal.utils.schema.span_attribute_schema import cloud_api_operation_v0
    from ddtrace.internal.utils.schema.span_attribute_schema import database_operation_v0
    from ddtrace.internal.utils.schema.span_attribute_schema import service_name_v0
    from ddtrace.internal.utils.schema.span_attribute_schema import url_operation_v0
...
def test_service_name_imports_v1():
    ...
    from ddtrace.internal.utils.schema import schematize_service_name
    from ddtrace.internal.utils.schema import schematize_url_operation
    from ddtrace.internal.utils.schema.span_attribute_schema import cache_operation_v1
    from ddtrace.internal.utils.schema.span_attribute_schema import cloud_api_operation_v1
    from ddtrace.internal.utils.schema.span_attribute_schema import database_operation_v1
    from ddtrace.internal.utils.schema.span_attribute_schema import service_name_v1
    from ddtrace.internal.utils.schema.span_attribute_schema import url_operation_v1
    from tests.conftest import DEFAULT_DDTRACE_SUBPROCESS_TEST_SERVICE_NAME
