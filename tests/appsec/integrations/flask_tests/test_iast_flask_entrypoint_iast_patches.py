...
def test_ddtrace_iast_flask_app_create_app_patch_auto():
    ...
    with override_global_config(dict(_iast_enabled=True)), override_env(dict(DD_IAST_ENABLED="true")):
        import tests.appsec.iast.fixtures.entrypoint.app_create_app_patch_auto  # noqa: F401
        ...
        del sys.modules["tests.appsec.iast.fixtures.entrypoint.app_create_app_patch_auto"]
