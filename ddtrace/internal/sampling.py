...
from ddtrace.internal.utils.constants import SAMPLING_DECISION_MAKER_INHERITED
from ddtrace.internal.utils.constants import SAMPLING_DECISION_MAKER_RESOURCE
from ddtrace.internal.utils.constants import SAMPLING_DECISION_MAKER_SERVICE
from ddtrace.internal.utils.constants import SAMPLING_DECISION_TRACE_TAG_KEY
from ddtrace.internal.utils.constants import SAMPLING_HASH_MODULO
...
def _set_sampling_tags(span: Span, sampled: bool, sample_rate: float, mechanism: int) -> None:
    ...
    if mechanism in (
        ...
        span._set_attribute(KNUTH_SAMPLE_RATE_KEY, format_rate(sample_rate))
